...
public class SelecaoIdiomas extends JFrame implements ActionListener{
	...
	//	this.getContentPane().add(new GridLayout(2,3,4,4));
		ImgPort = new ImageIcon("images/Button_br.gif");
		pt = new JButton("",ImgPort);
		CentroGridLayout.add(pt);

		ImgEngl = new ImageIcon("images/Button_en.jpg");
		en = new JButton("",ImgEngl);
		CentroGridLayout.add(en);

		ImgSpan = new ImageIcon("images/Button_sp.png");
		...
		pt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TelaLogin ln = new TelaLogin(ptBr, bundlePtBr);
		...
		en.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TelaLogin ln = new TelaLogin(enUs, bundleEnUs);
		...
		sp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TelaLogin ln = new TelaLogin(spCa, bundleSpCa);
